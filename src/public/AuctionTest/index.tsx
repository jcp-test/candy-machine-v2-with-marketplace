...
import { AuctionNftTest } from '../../components/AuctionNftTest';
 ...
 */
export const AuctionTest: React.FC<SellProps> = ({ wallet, walletConnectComponent, style, candyShop, enableCacheNFT }) => {
